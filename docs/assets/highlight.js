...
match:[t.concat(/\b/,t.either(...A)),/\./,n,/\b(?=\.)/],scope:{1:"built_in",
2:"punctuation",3:"type"}},{
match:[t.concat(/\b/,t.either(...A,...h)),/\./,n,/\b(?!\.)/],scope:{
...
relevance:10}],C=[{
match:t.either(",",/;/,/(?<=\w)\>/,/\<(?=\w)/,/\{|\}/,/\(|\)/,/\{|\}/),
scope:"punctuation",relevance:0},g],I=e.inherit(e.APOS_STRING_MODE,{
...
relevance:0,contains:[D,g,{match:t.concat(n),scope:"variable.constant"}]},{
...
endsWithParent:!0,keywords:{literal:y.literal,built_in:T},contains:[p,_,I,g,{
...
},B,F,_,C,i,{match:t.concat("(?<=this.)",a,"(?!\\()"),scope:"variable"},{
